    ...
    <main id="register">
      <background-blue-style>
        <template v-slot:content>
          <register-panel class="register-main-layout"></register-panel>
          <footer class="insight-copyright">
            <div id="footer">
...
<script>
  import backgroundBlueStyle from 'components/common/backgroundBlueStyle'
